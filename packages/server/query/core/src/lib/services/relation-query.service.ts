...
> extends ProxyQueryService<DTO, C, U> {
   ...
   */
  override async queryRelations<Relation>(
  ...
  override async aggregateRelations<Relation>(
    RelationClass: Class<Relation>,
    relationName: string,
    dto: DTO,
  ...
  override async countRelations<Relation>(
    RelationClass: Class<Relation>,
    relationName: string,
    dto: DTO | DTO[],
    filter: Filter<Relation>
   ...
   */
  override async findRelation<Relation>(
    RelationClass: Class<Relation>,
    relationName: string,
    dtos: DTO[],

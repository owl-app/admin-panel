...
export class NoOpQueryService<DTO, C = DeepPartial<DTO>, U = DeepPartial<DTO>>
  implements QueryService<DTO, C, U>
{
  private static instance: QueryService<unknown, unknown, unknown> =
  ...
  createMany(items: C[]): Promise<DTO[]> {
    return Promise.reject(
      new NotImplementedException('createMany is not implemented')
    );
  }

  createOne(item: C): Promise<DTO> {
    return Promise.reject(
      new NotImplementedException('createOne is not implemented')
    );
  }

  deleteMany(
    filter: Filter<DTO>,
    opts?: DeleteManyOptions<DTO>
  ): Promise<DeleteManyResponse> {
    return Promise.reject(
      new NotImplementedException('deleteMany is not implemented')
    );
  }

  deleteOne(id: number | string, opts?: DeleteOneOptions<DTO>): Promise<DTO> {
    return Promise.reject(
      new NotImplementedException('deleteOne is not implemented')
    );
  }
  ...
  findById(
    ...
    return Promise.reject(
      new NotImplementedException('findById is not implemented')
    );
  }
  ...
  findRelation<Relation>(
    ...
    return Promise.reject(
      new NotImplementedException('findRelation is not implemented')
    );
  }

  getById(id: string | number, opts?: GetByIdOptions<DTO>): Promise<DTO> {
    return Promise.reject(
      new NotImplementedException('getById is not implemented')
    );
  }

  query(query: Query<DTO>, opts?: QueryOptions): Promise<DTO[]> {
    return Promise.reject(
      new NotImplementedException('query is not implemented')
    );
  }
  ...
  aggregate(
    ...
    return Promise.reject(
      new NotImplementedException('aggregate is not implemented')
    );
  }

  count(filter: Filter<DTO>, opts?: CountOptions): Promise<number> {
    return Promise.reject(
      new NotImplementedException('count is not implemented')
    );
  }
  ...
  queryRelations<Relation>(
    ...
    return Promise.reject(
      new NotImplementedException('queryRelations is not implemented')
    );
  }
  ...
  countRelations<Relation>(
    ...
    return Promise.reject(
      new NotImplementedException('countRelations is not implemented')
    );
  }
  ...
  removeRelation<Relation>(
    ...
    return Promise.reject(
      new NotImplementedException('removeRelation is not implemented')
    );
  }
  ...
  removeRelations<Relation>(
    ...
    return Promise.reject(
      new NotImplementedException('removeRelations is not implemented')
    );
  }
  ...
  setRelations<Relation>(
    ...
    return Promise.reject(
      new NotImplementedException('setRelations is not implemented')
    );
  }
  ...
  setRelation<Relation>(
    ...
    return Promise.reject(
      new NotImplementedException('setRelation is not implemented')
    );
  }

  updateMany(update: U, filter: Filter<DTO>): Promise<UpdateManyResponse> {
    return Promise.reject(
      new NotImplementedException('updateMany is not implemented')
    );
  }
  ...
  > {
    return Promise.reject(
      new NotImplementedException('aggregateRelations is not implemented')
    );
  }
}

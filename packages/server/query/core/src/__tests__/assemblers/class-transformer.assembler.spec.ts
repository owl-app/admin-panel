...
describe('ClassTransformerAssembler', () => {
  ...
  describe('with serializer', () => {
    const testDtoSerialize = jest.fn((td: TestSerializeDTO) => ({
    ...
    class TestSerializeClassAssembler extends ClassTransformerAssembler<
      TestSerializeDTO,
      TestSerializeEntity
    > {}
  ...
  describe('with deserializer', () => {
    ...
    class TestDesrializeClassAssembler extends ClassTransformerAssembler<
      TestDeserializeDTO,

...
describe('applyFilter', () => {
  ...
  describe('nested objects', () => {
    ...
    it('should handle between comparisons', () => {
      const parentFilter: Filter<ParentDTO> = {
        child: { first: { between: { lower: 'a', upper: 'c' } } },
      };
      const grandParentFilter: Filter<GrandParentDTO> = {
    ...
    it('should handle notBetween comparisons', () => {
      const parentFilter: Filter<ParentDTO> = {
        child: { first: { notBetween: { lower: 'a', upper: 'c' } } },
      };
      const grandParentFilter: Filter<GrandParentDTO> = {
  ...
  describe('nested nulls', () => {
    ...
    it('should handle between comparisons', () => {
      expect(
        applyFilter(singleNestedNull(), {
          child: { first: { between: { lower: 'foo', upper: 'bar' } } },
        })
      ).toBe(false);
      expect(
        applyFilter(doubleNestedNull(), {
    ...
    it('should handle notBetween comparisons', () => {
      expect(
        applyFilter(singleNestedNull(), {
          child: { first: { notBetween: { lower: 'foo', upper: 'bar' } } },
        })
      ).toBe(true);
      expect(
        applyFilter(doubleNestedNull(), {

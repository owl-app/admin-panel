...
describe('AssemblerQueryService', () => {
  ...
  describe('query', () => {
    it('transform the query and results', () => {
      ...
      const assemblerService = new AssemblerQueryService(
        new TestAssembler(),
      ...
      return expect(
        assemblerService.query({ filter: { foo: { eq: 'bar' } } })
  ...
  describe('count', () => {
    it('transform the filter and results', () => {
      ...
      when(
        mockQueryService.count(
          objectContaining({ bar: { eq: 'bar' } }),
          undefined
        )
      ).thenResolve(1);

      return expect(
        assemblerService.count({ foo: { eq: 'bar' } })
      ).resolves.toBe(1);
    });
  });
  ...
  describe('findById', () => {
    it('should transform the results', () => {
      ...
      return expect(assemblerService.findById(1)).resolves.toEqual({
        foo: 'bar',
      });
    });
    ...
    it('should transform a filter if provided', () => {
      ...
      return expect(
        assemblerService.findById(1, { filter: { foo: { eq: 'bar' } } })
      ).resolves.toEqual({ foo: 'bar' });
    });
  ...
  describe('queryRelations', () => {
    it('should transform the results for a single entity', () => {
      ...
      return expect(
        assemblerService.queryRelations(
          TestDTO,
          'test',
          { foo: 'bar' },
          { filter: { foo: { eq: 'bar' } } }
    ...
    it('should transform the results for multiple entities', () => {
      ...
      return expect(
        assemblerService.queryRelations(TestDTO, 'test', [{ foo: 'bar' }], {
          filter: { foo: { eq: 'bar' } },
        })
  ...
  describe('aggregateRelations', () => {
    it('should transform the results for a single entity', () => {
      ...
      return expect(
        assemblerService.aggregateRelations(
          TestDTO,
          'test',
          { foo: 'bar' },
          { foo: { eq: 'bar' } },
    ...
    it('should transform the results for multiple entities', () => {
      ...
      when(
        ...
        Promise.resolve(
          new Map<TestEntity, AggregateResponse<TestDTO>>([
            [entities[0], result],
          ])
        )
      );
  ...
  describe('countRelations', () => {
    it('should transform the results for a single entity', () => {
      ...
      return expect(
        assemblerService.countRelations(
          TestDTO,
          'test',
          { foo: 'bar' },
          { foo: { eq: 'bar' } }
    ...
    it('should transform multiple entities', () => {
      ...
      return expect(
        assemblerService.countRelations(TestDTO, 'test', [{ foo: 'bar' }], {
          foo: { eq: 'bar' },
        })
  ...
  describe('findRelation', () => {
    it('should transform the results for a single entity', () => {
      ...
      return expect(
        assemblerService.findRelation(TestDTO, 'test', { foo: 'bar' })
      ).resolves.toEqual({ foo: 'bar' });
    });
  ...
  describe('addRelations', () => {
    it('should transform the results for a single entity', () => {
      ...
      return expect(
        assemblerService.addRelations('test', 1, [2, 3, 4])
    ...
    it('should transform the filter and results for a single entity', async () => {
      ...
      const addResult = await assemblerService.addRelations(
        'test',
        1,
        [2, 3, 4],
        {
  ...
  describe('setRelations', () => {
    it('should transform the results for a single entity', () => {
      ...
      when(
        mockQueryService.setRelations('test', 1, deepEqual([2]), undefined)
      ).thenResolve({
        bar: 'baz',
      });
  ...
  describe('removeRelation', () => {
    it('should transform the results for a single entity', () => {
      ...
      when(
        mockQueryService.removeRelation('test', 1, 2, undefined)
      ).thenResolve({
        bar: 'baz',
      });
    ...
    it('should transform the options and results for a single entity', () => {
      ...
      when(
        mockQueryService.removeRelation(
          'test',
          1,
          2,
          objectContaining({ filter: { bar: { eq: 'bar' } } })
  ...
  describe('getById', () => {
    it('should transform the results', () => {
      ...
      return expect(assemblerService.getById(1)).resolves.toEqual({
        foo: 'bar',
      });
    });
    ...
    it('should transform the filter and results', () => {
      ...
      when(
        mockQueryService.getById(
          1,
          deepEqual({ filter: { bar: { eq: 'bar' } } })
        )
      ).thenResolve({
        bar: 'bar',
      });
      ...
      return expect(
        assemblerService.getById(1, { filter: { foo: { eq: 'bar' } } })
      ).resolves.toEqual({ foo: 'bar' });
    });
  });
  ...
  describe('createOne', () => {
    it('should transform the results for a single entity', () => {
      ...
      when(
        mockQueryService.createOne(objectContaining({ bar: 'baz' }))
      ).thenResolve({
        bar: 'baz',
      });

      return expect(
        assemblerService.createOne({ foo: 'baz' })
      ).resolves.toEqual({ foo: 'baz' });
    });
  });
  ...
  describe('createMany', () => {
    it('should transform the results for a single entity', () => {
      ...
      when(
        mockQueryService.createMany(deepEqual([{ bar: 'baz' }]))
      ).thenResolve([{ bar: 'baz' }]);

      return expect(
        assemblerService.createMany([{ foo: 'baz' }])
      ).resolves.toEqual([{ foo: 'baz' }]);
    });
  });
  ...
  describe('updateOne', () => {
    it('should transform the results for a single entity', () => {
      ...
      return expect(
        assemblerService.updateOne(1, { foo: 'baz' })
      ).resolves.toEqual({ foo: 'baz' });
    });
  ...
  describe('updateMany', () => {
    it('should transform the arguments', () => {
      ...
      return expect(
        assemblerService.updateMany({ foo: 'baz' }, { foo: { eq: 'bar' } })
      ).resolves.toEqual({
        updatedCount: 1,
      });
    });
  ...
  describe('deleteOne', () => {
    it('should transform the results for a single entity', () => {
      ...
      return expect(assemblerService.deleteOne(1)).resolves.toEqual({
        foo: 'baz',
      });
    });
    ...
    it('should transform the filter and results for a single entity', () => {
      ...
      return expect(
        assemblerService.deleteOne(1, { filter: { foo: { eq: 'bar' } } })
      ).resolves.toEqual({ foo: 'baz' });
    });
  });
  ...
  describe('deleteMany', () => {
    it('should transform the arguments', () => {
      ...
      when(
        mockQueryService.deleteMany(objectContaining({ bar: { eq: 'bar' } }))
      ).thenResolve({ deletedCount: 1 });

      return expect(
        assemblerService.deleteMany({ foo: { eq: 'bar' } })
      ).resolves.toEqual({
        deletedCount: 1,
      });
    });

  ...
  implements QueryService<DTO, C, U>
{
  ...
  async createWithRelations(
    ...
    const c = await this.queryService.createWithRelations(await this.assembler.convertToCreateEntity(item), relations)
  ...
  queryWithCount(query: Query<DTO>, opts?: QueryOptions):  Promise<[DTO[], number]> {
    return this.assembler.convertAsyncToDTOsWithCount(this.queryService.queryWithCount(this.assembler.convertQuery(query), opts))
  }
  ...
  async updateOne(id: string | number, update: U, opts?: UpdateOneOptions<DTO>): Promise<DTO> {
    return this.assembler.convertAsyncToDTO(
      this.queryService.updateOne(id, await this.assembler.convertToUpdateEntity(update), this.convertFilterable(opts))
    )
  }
  ...
  convertModifyRelationsOptions<Relation>(

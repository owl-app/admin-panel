  ...
  implements QueryService<Entity, DeepPartial<Entity>, DeepPartial<Entity>>
{
  ...
  /**
   * Query for multiple entities, using a Query from `@owl-app/crud-core`.
   *
   * @example
   * ```ts
  ...
  /**
   * Delete multiple records with a `@owl-app/crud-core` `Filter`.
   *
   * @example
   *
   * ```ts
  ...
  /**
   * Restores multiple records with a `@owl-app/crud-core` `Filter`.
   *
   * @example
   *
   * ```ts
